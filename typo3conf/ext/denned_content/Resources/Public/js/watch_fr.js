...
var clockSettings = {
    ...
    flashname: 'denned_300x114_fr', /* set the flash name without .swf (place the file in the img folder)*/
    trackingurl: 'http://www.rolex.com/fr?cmpid=dw201401037', /* set the tracking url */
    trackingPixel: '',
