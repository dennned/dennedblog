...
var clockSettings = {
    ...
    flashname: 'denned_300x114_ko', /* set the flash name without .swf (place the file in the img folder)*/
    trackingurl: 'http://www.rolex.com/ko?cmpid=dw201401038', /* set the tracking url */
    trackingPixel: '',
